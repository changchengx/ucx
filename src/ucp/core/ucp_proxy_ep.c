...
UCP_PROXY_EP_DEFINE_OP(ucs_status_t, get_ece, uint32_t*)
UCP_PROXY_EP_DEFINE_OP(ucs_status_t, set_ece, uint32_t)
                    ...
                    uct_ep_h uct_ep, int is_owner)
{
    ...
    UCP_PROXY_EP_SET_OP(ep_get_ece);
    UCP_PROXY_EP_SET_OP(ep_set_ece);
